        ...
        <div class="col-span-full">
            <nav class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-4">
                    <a href="../index.html" class="text-green-600 hover:text-green-700">Startseite</a>
                    <a href="shopping.html" class="text-green-600 hover:text-green-700">Einkaufsliste</a>
                </div>
            </nav>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="flex gap-4 p-6 bg-gray-50 border-t">
